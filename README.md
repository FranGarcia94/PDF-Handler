...
[^2]: The program will not allow you to choose a `Start sheet` higher than a `End sheet`, generating the following error message.<br></br>![ERROR](https://user-images.githubusercontent.com/107102754/217888902-3bacdfbe-174a-4667-9de3-2374447dd4e1.png)
